...
//
// 26 group-stage match results scraped from worldcupstats.football
//
...
export const groupPhaseScrapeResults: Record<number, ScrapeResult> = {
  ...
  // Switzerland 0–0 Bosnia and Herzegovina — Thu, Jun 18, 3:00 PM ET
  "9": {"result":"draw","homeScore":0,"awayScore":0,"home":"Switzerland","away":"Bosnia and Herzegovina","date":"Thu, Jun 18","time":"3:00 PM"},
